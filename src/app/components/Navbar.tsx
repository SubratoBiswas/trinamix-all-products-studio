...
export function Navbar({ activeSection }: { activeSection: string }) {
  ...
  return (
    <motion.nav
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      className="navbar fixed top-0 left-0 right-0 z-50 backdrop-blur-xl border-b"
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold nav-text">AI Platform</span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="theme-toggle w-10 h-10 rounded-xl flex items-center justify-center transition-all"
          >
            {isDark
