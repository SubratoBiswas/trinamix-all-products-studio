 ...
 * The canonical source of truth is now MongoDB (via the Express backend).
 */
export const STORAGE_KEY = 'trinamix_admin_v1';

/**
 * Previously this was the Firebase Realtime Database path.
 * It is kept here only for reference / migration notes and is no longer used.
 * @deprecated  replaced by the Express /api/registry endpoint.
 */
